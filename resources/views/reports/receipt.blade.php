<div id="invoice-POS">
    ...
    <div class="mid">
        <div class="info">
            ...
            <p>
                Address:peshawar.
                <br> Email:asohial@gmail.com.
                <br>Phone:03224542233.
            </p>
        ...
        <div id="table">
            <table>
                ...
                @foreach ($orders_receipt as $receipt)
                    <tr class="service">
                        ...
                        <td class="tableitem">
                            <p class="itemtext">{{ $receipt->qauntity }}</p>
                        </td>
                        <td class="tableitem">
                ...
                <tr class="tabletitle">
                    ...
                    <td class="payment">
                        <p class="itemtext">Num Total $ {{ number_format($receipt->amount, 2) }}</p>
                    </td>
                </tr>
                <tr>
                    <td></td>
                    ...
                    <td class="payment"> {{ number_format($orders_receipt->sum('amount'), 2) }}
                        <h2></h2>
                    </td>
                </tr>
            ...
            <div class="legalcopy">
                <p class="legal"><strong>
                    ...
                    <br> The good which are subject to tax, prices are includes tax
                </p>
            </div>
